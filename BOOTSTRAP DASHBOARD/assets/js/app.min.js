!(function (n) {
				...
				n('.side-nav').length &&
					...
					n('.side-nav a').each(function () {
						...
						this.href == o &&
							...
							'sidebar-menu' !==
								(t = n(this).parent().parent().parent().parent().parent().parent()).attr('id') &&
								t.addClass('show'),
							n(this)
								.parent()
								.parent()
							...
							(a = n(this)
								...
								.parent()
								.parent()
								.parent()).is('body') || a.addClass('menuitem-active'));
					}));
		...
		(t.prototype.initMenu = function () {
			...
			(t.prototype.initSearch = function () {
				...
				a(document).on('click', function (t) {
					return (
						'top-search' == t.target.id || t.target.closest('#search-dropdown')
	...
	(function (a) {
		...
		(t.prototype._selectOptionsFromConfig = function () {
			...
			(t.prototype.init = function () {
				var e = this;
				'true' == document.body.getAttribute('data-rightbar-onstart') &&
					(localStorage.getItem('_HYPER_VISITED') ||
						(localStorage.setItem('_HYPER_VISITED', !0), e.toggleRightSideBar())),
	...
	(function (a) {
		...
		(t.prototype._saveConfig = function (t) {
			...
			(t.prototype._getStoredConfig = function () {
				...
				e && 'dark' == e && (t.isDarkModeEnabled = !0),
					(t.sideBarTheme = this.body.attr('data-leftbar-theme')),
					'boxed' === this.body.attr('data-layout-mode') && (t.isBoxed = !0);
				...
				document.body.setAttribute('data-layout-color', 'dark'),
					'detached' === !this.body.attr('data-layout')
						? (a.LeftSidebar.activateDarkTheme(),
						  this._saveConfig({ isDarkModeEnabled: !0, sideBarTheme: n }))
			...
			(t.prototype.initShowHidePassword = function () {
				a('[data-password]').on('click', function () {
					'false' == a(this).attr('data-password')
						? (a(this).siblings('input').attr('type', 'text'),
						  a(this).attr('data-password', 'true'),
						  a(this).addClass('show-password'))
			...
			(t.prototype.initSyntaxHighlight = function () {
				a(document).ready(function (t) {
					document.querySelectorAll('pre span.escape').forEach(function (t, e) {
						for (
							var a = 1 / 0,
								o = (t.classList.contains('escape'), t.innerText)
									.replace(/^\n/, '')
									.trimRight()
									.split('\n'),
								n = 0;
			...
			(t.prototype.init = function () {
				...
				window.sessionStorage &&
					...
					(sessionStorage.getItem('_HYPER_VISITED_') ||
						(n.RightBar.toggleRightSideBar(), sessionStorage.setItem('_HYPER_VISITED_', !0))),
					n.Portlet.init(),
